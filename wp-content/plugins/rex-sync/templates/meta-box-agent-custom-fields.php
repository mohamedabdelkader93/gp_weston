...
$agent_custom_fields_mapping = $settings['agent_custom_fields_mapping'];
...
if($agent_custom_fields_mapping) {
    echo "<ul>";
    render_value('_rsc.agent_id', $post->{'_rsc.agent_id'});
    foreach ($agent_custom_fields_mapping as $field_key => $map_key) {
