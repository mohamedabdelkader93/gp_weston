...
function efrekia_register_required_plugins() {
	...
	$plugins = array(
		...
		// 	efrekia-essential-plugin
		array(
			'name'               => 'Efrekia Essential Plugin', // The plugin name.
			'slug'               => 'efrekia-essential-plugin', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/lib/plugins/efrekia-essential-plugin.zip', // The plugin source.
	...
	array(
		...
		array(
			'name'      => 'ACF options Import Export',
			'slug'      => 'acf-options-importexport',
			'required'  => true,
		),
